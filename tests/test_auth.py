...
class TestGetCurrentUser:
    ...
    def test_get_me_authenticated(
        ...
        response = client.get("/api/auth/me", headers=client_auth_headers)
        assert response.status_code == 200
        data = response.json()
...
class TestGetUserById:
    ...
    def test_get_user_by_id_success(
        ...
        response = client.get(
            f"/api/auth/users/{test_ba_user.id}", headers=client_auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_get_user_by_id_not_found(
        ...
        response = client.get("/api/auth/users/99999", headers=client_auth_headers)
    ...
    def test_get_user_by_id_unauthenticated(
        ...
        response = client.get(f"/api/auth/users/{test_ba_user.id}")
        assert response.status_code == 401
